...
“萌宠情报局”商城系统模块功能介绍：
1.主页，游客及会员均可访问，游客为未注册状态，会员为已注册用户，主页左上角为“萌宠情报局”标题及logo。顶部居中为搜索框，可按关键字搜索商品，顶部右侧为小人图标点击可跳转至个人中心。
搜索框下方为宠物分类，根据宠物商品的类型显示，类型上方放置对应图片，点击可进入只包含该类型的宠物的商品页面，宠物分类下方为热门宠物推荐，展示部分近期成交的宠物类型或随机抽取一些宠物展示，展示内容包括宠物图片，宠物名，简介，价格，及查看详情键，展示宠物图片宠物分类右侧有较窄的一列限时促销商品，在后端添加商品时可设置某宠物原价及打折价格。在这里展示。再下方为附近店铺，展示店铺图片，名称，真实地理位置，相距距离，营业时间及查看详情键。
最下方为分栏，分为三栏，默认选择最左边的首页，中间为购物车，可跳转至购物车界面，最右边为个人中心。



1.输入网址进入主页
2.游客可搜索商品及查看商品和店铺详情，但没有购物车相关权限
3.游客点击加入购物车或个人中心时，出现提示链接提示登录，点击跳转至注册登录页面，进行登录后回到主页，此时拥有购物车相关权限，个人中心部分展示个人信息，包括收货地址，历史订单等
4.在主页附近店铺及宠物详情页点击店铺跳转至店铺详情页，在店铺名右边按钮分别为地址按钮和路线按钮，点击地址在地图上显示店铺所在位置，点击路线展示从此处到地图上店铺位置的最佳路线。
5.注册登录页输入管理员账户进入后台管理页，可输入相关信息增加店铺，增加商品，管理用户。