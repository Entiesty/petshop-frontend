  ...
  <div class="login-container">
    ...
    <div class="login-box">
      <div class="tab-container">
        ...
        <div :class="['tab', { active: activeTab === 'emailLogin' }]" @click="switchTab('emailLogin')">邮箱登录</div>
      </div>
      ...
      <div v-if="activeTab === 'login'" class="login-form">
        ...
        <div class="remember-container">
          ...
          <div class="right-links">
            <a href="#" class="forgot-link" @click.prevent="switchTab('emailLogin')">邮箱登录</a>
      ...
      <!-- 邮箱登录表单 -->
      <div v-if="activeTab === 'emailLogin'" class="login-form">
        <h2>邮箱验证码登录</h2>
        ...
        <div class="form-item">
          ...
          <div class="input-container code-container">
            <i class="icon password-icon"></i>
            <input type="text" v-model="emailLoginForm.code" placeholder="请输入验证码" />
            <button
              class="code-button"
        ...
        <button class="login-button" @click="handleEmailLogin">登录</button>

        <div class="login-link">
          <span>已有账号？</span>
          <a href="#" @click.prevent="switchTab('login')">密码登录</a>
        </div>
      </div>
...
const sendVerificationCode = async () => {
  ...
  try {
    await axios.post(AUTH_API.SEND_CODE, {
...
const handleEmailLogin = async () => {
  ...
  try {
    console.log('准备发送邮箱登录请求，URL:', AUTH_API.LOGIN_BY_CODE)
    console.log('请求数据:', { email: emailLoginForm.email, code: emailLoginForm.code })

    const response = await axios.post(AUTH_API.LOGIN_BY_CODE, {
      email: emailLoginForm.email,
    ...
    if (response.data.accessToken) {
      ...
      localStorage.setItem('username', emailLoginForm.email) // 使用邮箱作为用户名显示
